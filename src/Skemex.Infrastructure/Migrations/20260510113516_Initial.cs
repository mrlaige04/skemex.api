    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tenants_users", x => x.Id);
                    table.ForeignKey(
                        name: "FK_tenants_users_tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_tenants_users_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_roles_permissions_RoleId_PermissionId",
                table: "roles_permissions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tenants_users_TenantId",
                table: "tenants_users",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_tenants_users_UserId_TenantId",
                table: "tenants_users",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_user_roles_UserId_RoleId_TenantId",
                table: "user_roles",
