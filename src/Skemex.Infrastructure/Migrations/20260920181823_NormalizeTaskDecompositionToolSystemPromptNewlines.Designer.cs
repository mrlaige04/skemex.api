...
namespace Skemex.Infrastructure.Migrations
{
    ...
    [Migration("20260920181823_NormalizeTaskDecompositionToolSystemPromptNewlines")]
    partial class NormalizeTaskDecompositionToolSystemPromptNewlines
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Skemex.Domain.Entities.Ai.AgentTool", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Skemex.Domain.Entities.Ai.AiAgentJob", b =>
                {
                    ...
                    b.ToTable("ai_agent_jobs", (string)null);
                });
            ...
            modelBuilder.Entity("Skemex.Domain.Entities.Ai.AiProvider", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Skemex.Domain.Entities.Projects.ProjectDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int?>("VectorizedChunkCount")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Skemex.Domain.Entities.Projects.ProjectDocumentChunk", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("project_document_chunks", (string)null);
                });
            ...
            modelBuilder.Entity("Skemex.Domain.Entities.Projects.ProjectDocumentChunk", b =>
                {
                    b.HasOne("Skemex.Domain.Entities.Projects.ProjectDocument", "Document")
                        .WithMany()
